...
import com.sanxiang.bank.config.MyEndpointConfigure;
    ...
    public void onOpen(Session session) {
        ...
        new Thread(() -> {
            ...
            while (sessionMap.get(session.getId()) != null) {
                ...
                try {
                    //日志文件路径，获取最新的
//                    String filePath = "./logs/" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + "/"+"spring"+".log";
                    String filePath = "./logs/spring.log";
                    //字符流
