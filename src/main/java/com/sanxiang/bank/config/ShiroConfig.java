...
import com.sanxiang.bank.common.security.*;
...
public class ShiroConfig {
    ...
    public Authenticator authenticator() {
        ...
        authenticator.setRealms(Arrays.asList(jwtShiroRealm(), dbShiroRealm(),userEmailRealm()));
...
//        //No certification required
        c.addPathDefinition("/websocket/logging", "anon");
        c.addPathDefinition("/thymeleaf/**", "anon,cors");
        c.addPathDefinition("/logging/**", "anon,cors");
        c.addPathDefinition("/register", "anon,cors");
        c.addPathDefinition("/login", "anon,cors");
        c.addPathDefinition("/logout", "anon,cors");
        c.addPathDefinition("/image/**","anon,cors");
        c.addPathDefinition("/deposit/**","anon,cors");
//        //Jwt
